...
export async function discoverArticles(category = 'general', lang = 'sr') {
  ...
  // Specific, targeted queries — NOT generic "trends 2026" roundups
  const queries = [
    'site:vegnews.com OR site:plantbasednews.org new article 2026',
    'vegan recipe chickpea OR lentil OR tofu published 2026',
    'plant-based health study published 2026 heart OR diabetes OR gut',
    'vegan ingredient turmeric OR spirulina OR hemp seeds benefits',
    'plant-based myth debunked protein OR B12 OR iron 2026',
    'vegan cooking tip meal prep OR fermentation OR sourdough',
    'new vegan product launch OR restaurant opening 2026',
    'plant-based diet weight loss OR muscle building study',
    'vegan dessert recipe chocolate OR banana OR oat 2026',
    'Mediterranean plant-based diet benefits new research',
    'plant-based milk oat OR almond OR soy comparison health',
    'vegan athlete nutrition performance recovery plant protein',
  ];
